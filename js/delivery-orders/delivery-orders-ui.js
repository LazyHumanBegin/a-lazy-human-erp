/**
 * EZCubic - Delivery Orders UI Module - UI Rendering and Modals
...
function renderDeliveryOrdersList() {
    ...
    const deliveryOrders = window.deliveryOrders || [];
    const currentDOTab = window.currentDOTab || 'outgoing';
    const DO_STATUS = window.DO_STATUS;
...
window.renderDeliveryOrdersList = renderDeliveryOrdersList;
window.filterDOList = filterDOList;
window.showCreateDOModal = showCreateDOModal;
window.createDOItemRow = createDOItemRow;
